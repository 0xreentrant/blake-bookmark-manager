...
export const Entry = ({
  ...
  return (
    <div className="flex justify-center">
      <div
        className="flex border rounded-lg p-2 w-full max-w-5xl"
        style={style}
      >
        ...
        <div className="flex flex-col grow max-w-[calc(100%-1.25rem)] pl-2 divide-y">
          <div className="truncate pb-1.5 w-full">
            <Link className="lg:hidden font-bold" title={title} href={href}>
              {title}
            </Link>
            ...
            <div className="hidden lg:flex">
              <div className="truncate  max-w-[75%]">
                <Link className="font-bold" title={title} href={href}>
                  {title}
                </Link>
              </div>
              ...
              <AlertDialog.Portal>
                ...
                <AlertDialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                  ...
                  <AlertDialog.Description className="text-mauve11 mt-4 mb-5 text-[15px] leading-normal">
                    ...
                    this bookmark, it will be removed from all lists it is a
                    part of.
